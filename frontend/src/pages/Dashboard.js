    ...
    <div className="space-y-4 sm:space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 animate-fade-in-up stagger-children">
        ...
        <Card className="hover:shadow-md transition-all duration-300 hover:scale-105 animate-fade-in-up animation-delay-200">
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold text-blue-600 hover:animate-pulse transition-all">{stats.inProgressTasks}</div>
            <p className="text-xs text-gray-600 leading-tight">
        ...
        <Card className="hover:shadow-md transition-all duration-300 hover:scale-105 animate-fade-in-up animation-delay-300">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Overdue</CardTitle>
            <AlertCircle className="h-4 w-4 text-red-600" />
          </CardHeader>
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold text-red-600 hover:animate-pulse transition-all">{stats.overdueTasks}</div>
            <p className="text-xs text-gray-600 leading-tight">
